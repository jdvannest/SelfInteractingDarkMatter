...
for z in ['.z0','.z1']:
    ...
    for b in [False,True]:
        ...
        f.savefig(f'../Plots/MassFunctionComparison{z}{fname}.png',bbox_inches='tight',pad_inches=.1)
    ...
    for b in [False,True]:
        ...
        f.savefig(f'../Plots/MassFunctionComparison.Inverted{z}{fname}.png',bbox_inches='tight',pad_inches=.1)
    ...
    for b in [False,True]:
        ...
        f.savefig(f'../Plots/MassHistogramComparison{z}.{fname}.png',bbox_inches='tight',pad_inches=.1)