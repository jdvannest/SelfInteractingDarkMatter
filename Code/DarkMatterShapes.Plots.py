...
ax.set_ylim([0,1])
ax.tick_params(length=5,labelsize=15)
ax.set_xlabel(f'b/a [AHF]',fontsize=25)
ax.set_ylabel(f'c/a [AHF]',fontsize=25)
ax.set_title(im,fontsize=25)
ax.plot([0,1],[0,1],c='0.5',linestyle='--')
ax.scatter(b,c,c='k',marker='.',s=.75**2)
...
if args.pynbody:
    ...
    ax.set_ylim([0,1])
    ax.tick_params(length=5,labelsize=15)
    ax.set_xlabel(f'{lab}b/a [Pynbody]',fontsize=25)
    ax.set_ylabel(f'{lab}c/a [Pynbody]',fontsize=25)
    ax.set_title(im,fontsize=25)
    ax.plot([0,1],[0,1],c='0.5',linestyle='--')
    ...
    ax[0].set_xlabel(f'{lab}b/a [AHF]',fontsize=25)
    ax[0].set_ylabel(f'{lab}c/a [AHF]',fontsize=25)
    ax[1].set_xlabel(f'{lab}b/a [Pynbody]',fontsize=25)
    ax[1].set_ylabel(f'{lab}c/a [Pynbody]',fontsize=25)
